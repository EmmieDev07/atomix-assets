...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2026 at 11:16 AM
...
--
ALTER TABLE `class_students`
  MODIFY `class_stud_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `game_access_codes`
  MODIFY `code_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
...
--
ALTER TABLE `questions_master`
  MODIFY `question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=210;
...
--
ALTER TABLE `quiz_choices`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=578;

--
-- AUTO_INCREMENT for table `quiz_questions`
--
ALTER TABLE `quiz_questions`
  MODIFY `quiz_question_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=199;
...
--
ALTER TABLE `student_quizzes`
  MODIFY `student_quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
