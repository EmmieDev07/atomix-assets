<?php
/**
 * Download pretest question import template for teachers.
 */
...
$sheet->setTitle('Pretest Questions');
...
$sheet->setCellValue('A2', 'What is the center of an atom?');
$sheet->setCellValue('B2', 'Nucleus');
$sheet->setCellValue('C2', 'Electron');
$sheet->setCellValue('D2', 'Proton shell');
$sheet->setCellValue('E2', 'Neutron cloud');
...
$filename = 'template_pretest_questions.xlsx';
